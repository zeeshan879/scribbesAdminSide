    ...
    <>
      <div className={ps.main_wrapper}>
        <div className="px-[24px]">
          ...
          <div className="max-w-[800px] text-sm lg:text-base font-DM text-[#BCBCBC] leading-[20px]">
          ...
          <div className="flex justify-between items-center gap-2 mt-3">
            <div>
              <div className="text-base lg:text-[20px] font-Dm font-normal">
                Text message
              </div>
              <div className="max-w-[850px] text-sm lg:text-base font-DM text-[#BCBCBC] leading-[20px]">
          ...
          <div className="flex justify-between items-center gap-3 mt-3">
            <div>
              <div className="text-base lg:text-[20px] font-Dm font-normal">Email</div>
              <div className="max-w-[850px] text-sm lg:text-base font-DM text-[#BCBCBC] leading-[20px]">
        ...
        <div className="px-[24px]">
          ...
          <div className="flex justify-between items-center gap-3 mt-3">
            <div>
              <div className="text-sm lg:text-[20px] font-Dm font-normal">Admins only</div>
            </div>
            <div>
              <label class="container2">
                <input type="checkbox" />
          ...
          <div className="flex justify-between items-center gap-3 mt-3">
            <div>
              <div className="text-base lg:text-[20px] font-Dm font-normal">Users only</div>
            </div>
            <div>
              <label class="container2">
                <input type="checkbox" />
