    ...
    <>
      <div className={fa.follwes_main_box}>
        <div className="flex justify-between items-center">
          <div className="font-bold font-grotesk text-[20px]">
            Followers Analysis
          </div>
        ...
        <div className="w-full flex gap-[100px] justify-between items-center pt-[25px]">
          ...
          <div className="w-[75%] flex flex-col gap-[30px]">
            ...
            <div className="flex gap-[30px] items-center">
              <div className="h-[120px] w-[120px]">
                <RangeProgressChart data={progresChartData2} data2={progresChartData2} />
              </div>
