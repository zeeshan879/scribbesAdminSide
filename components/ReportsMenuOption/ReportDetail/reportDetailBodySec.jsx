  ...
  return (
    <>
      <div className="body_container">
        ...
        <div className={rd.main_content_wrapper}>
          <div className={rd.profile_wraper}>
            <div className={rd.profile_left_box}>
              ...
              <div className="font-DM font-bold text-[20px]">John Doe</div>
            ...
            <div className={rd.report_slider_iiner}>
              <div className="flex items-center gap-[47px]">
                ...
                <div className={rd.report_content}>
                  <div className="flex font-DM font-bold text-[20px] items-center">
                    Reported By:{" "}
                    <span className="font-normal">Someone User</span>{" "}
                    <span className="text-[#BCBCBC] text-base pl-2 items-center flex pt-1">
                      (02-02-2022)
                    </span>
                  </div>
                  <div className="flex font-DM font-bold text-[20px] items-center pt-[20px]">
                    User id:
                    <span className="font-normal">878787</span>
                  </div>
                  <div className="flex pt-[20px] font-DM font-bold text-[20px] items-center">
                    Report Category:
                  ...
                  <div className="flex font-DM pt-[20px] font-bold text-[20px] items-center">
                    Description:
                  </div>
                  <div className="max-w-[400px] text-base font-DM pt-[14px]">
        ...
        <div className="text-[#BCBCBC] font-DM text-[20px] w-[300px]">
