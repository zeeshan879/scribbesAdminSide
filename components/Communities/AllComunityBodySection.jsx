...
import AllCommunityCounts from "../Communities/allCommunityCounts"
import com from "../../Asstes/style/communites.module.css";
import AllCommunitiesTabs from "../Communities/allCommunitiesTabs"
import AllCommunitiesTableFilters from "./AllcommunitiesTableFilter";

const AllCommnityBodySection = () => {
  const tableData = [
    {
      name: "Basket Hounds",
      mark: true,
...
export default AllCommnityBodySection;
